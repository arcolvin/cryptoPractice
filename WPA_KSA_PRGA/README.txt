...
Once an X value has been identified, it can be inserted into FMS_Proof.py to show each step of the S array generation to verify that the 3 key values do infact not move once set in the 3rd iteration